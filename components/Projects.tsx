...
function Projects({ projects }: Props) {
  return (
    ...
    >
      ...
      <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 mt-[calc(8rem+64px)] md:mt-0 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#C084FC]/80">
