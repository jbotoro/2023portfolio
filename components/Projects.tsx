...
function Projects({ projects }: Props) {
  return (
    ...
    >
      ...
      <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 mt-[calc(8rem+64px)] md:mt-8rem scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#C084FC]/80">
        {projects.map((project, i) => (
          <div
            key={project._id}
            className="w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-10 h-[calc(100vh - 2.5rem - 24px)]"
          >
            <a
